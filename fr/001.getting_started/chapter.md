...
Avant de commencer, vous devez créer un dossier qui contiendra l'intégralité des données de votre quête. Vous pouvez le créer n'importe où, cela n'aura pas d'importance. Attention, sous Windows, l'éditeur plante si le chemin d'accès comporte une lettre accentuée.
